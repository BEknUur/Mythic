    ...
    humor_configs = [
        {
            ...
            'prompt': f"""Напиши короткую юмористическую главу (1-2 абзаца, 60-100 слов) 'Знакомство с комиком' о {full_name}. Стиль — лёгкий, современный, с иронией, личное обращение, без пошлости. Начни с фразы: 'Дорогие читатели, знакомьтесь — {full_name}!' Не повторяй пример, но держи стиль как в стендап-биографиях. {photo_instruction}"""
        },
        {
            'key': 'daily_comedy',
            'title': 'Комедия повседневности',
            'prompt': f"""Напиши короткую юмористическую главу (1-2 абзаца, 60-100 слов) 'Комедия повседневности' о {full_name}. Стиль — наблюдательный юмор, забавные детали, личные привычки, как будто рассказываешь другу. Не повторяй пример, но держи стиль как в стендапах о жизни. {photo_instruction}"""
        },
        {
            'key': 'social_media_star',
            'title': 'Звезда соцсетей',
            'prompt': f"""Напиши короткую юмористическую главу (1-2 абзаца, 60-100 слов) 'Звезда соцсетей' о {full_name} и его Instagram. Стиль — современный юмор, интернет-мемы, лёгкие шутки, личное обращение. Не повторяй пример, но держи стиль как в блогах о соцсетях. {photo_instruction}"""
        },
        {
            'key': 'photo_adventures',
            'title': 'Фотоприключения',
            'prompt': f"""Напиши короткую юмористическую главу (1-2 абзаца, 60-100 слов) 'Фотоприключения' о том, как {full_name} фотографируется. Стиль — визуальный юмор, описания забавных ситуаций, личное обращение. Не повторяй пример, но держи стиль как в стендапах о фото. {photo_instruction}"""
        },
        {
            'key': 'unique_style',
            'title': 'Неповторимый стиль',
            'prompt': f"""Напиши короткую юмористическую главу (1-2 абзаца, 60-100 слов) 'Неповторимый стиль' о внешности и стиле {full_name}. Стиль — добрый юмор, без злых шуток, позитив, личное обращение. Не повторяй пример, но держи стиль как в блогах о моде с юмором. {photo_instruction}"""
        },
        {
            'key': 'funny_wisdom',
            'title': 'Мудрость с юмором',
            'prompt': f"""Напиши короткую юмористическую главу (1-2 абзаца, 60-100 слов) 'Мудрость с юмором' о жизненной философии {full_name}. Стиль — философский юмор, жизненные наблюдения, личное обращение. Не повторяй пример, но держи стиль как в стендапах о смысле жизни. {photo_instruction}"""
        },
        {
            'key': 'social_butterfly',
            'title': 'Душа компании',
            'prompt': f"""Напиши короткую юмористическую главу (1-2 абзаца, 60-100 слов) 'Душа компании' о том, как {full_name} общается с людьми. Стиль — социальный юмор, истории о дружбе, личное обращение. Не повторяй пример, но держи стиль как в блогах о друзьях. {photo_instruction}"""
        },
        {
            'key': 'creative_chaos',
            'title': 'Творческий хаос',
            'prompt': f"""Напиши короткую юмористическую главу (1-2 абзаца, 60-100 слов) 'Творческий хаос' о креативности {full_name}. Стиль — креативный юмор, описания процесса, личное обращение. Не повторяй пример, но держи стиль как в блогах о творчестве с юмором. {photo_instruction}"""
        },
        {
            'key': 'finale_applause',
            'title': 'Финальные аплодисменты',
            'prompt': f"""Напиши короткую юмористическую финальную главу (1-2 абзаца, 60-100 слов) 'Финальные аплодисменты' о {full_name}. Стиль — тёплый финал, благодарность, позитивные пожелания, личное обращение. Не повторяй пример, но держи стиль как в финале стендапа. {photo_instruction}"""
        }
    ]
