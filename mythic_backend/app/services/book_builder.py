    ...
    chapter_configs = [
        {
            ...
            ПОСЛОВИЦА: "Красота спасет мир, но любовь спасет красоту"
            
            СТИЛЬ:
            - Очень личный, интимный тон как в романе
        ...
        },
        {
            ...
            4. Абзац: Подробное описание внешности - черты лица, глаза, улыбка
            5. Абзац: Заключение о честности и открытости
            
            ПОСЛОВИЦА: "Глаза - зеркало души, а улыбка - ключ к сердцу"
            ...
            Пиши как подробный портрет любимого человека в романе."""  
        },
        {
            'key': 'world_view',
            ...
            5. Абзац: Дар видеть красоту - редкое качество
            
            ПОСЛОВИЦА: "Красота в глазах смотрящего, но мудрость в сердце чувствующего"
            ...
            Пиши как глубокий психологический портрет в романе."""
        },
        {
            ...
            5. Абзац: Искренность как главное качество
            
            ПОСЛОВИЦА: "Время летит, но любовь остается навсегда"
            ...
            Пиши как дневник наблюдений влюбленного человека в романе."""
        },
        {
            'key': 'epilogue',
            'title': 'Эпилог: Благодарность',
            'emotional_intro': 'Эта книга подходит к концу, но восхищение остается навсегда...',
            'prompt': f"""Напиши эпилог "Благодарность" для {full_name} (4-5 абзацев).
            
            ПОЛ: {gender} - используй "{she_he}", "{her_his}"
            
            НАЧНИ с признания: "Эта книга подходит к концу, но восхищение остается навсегда..."
            
            СТРУКТУРА ЭПИЛОГА:
            1. Абзац: Благодарность за вдохновение и красоту
            2. Абзац: Пожелания продолжать быть собой
            3. Абзац: Пожелания любви, счастья и ярких моментов
            4. Абзац: Благодарность за то, что такие люди существуют
            5. Абзац: "Спасибо за то, что ты есть. Твой поклонник." - заключение
            
            ПОСЛОВИЦА: "Спасибо за красоту, которая делает мир прекраснее"
            
            СТИЛЬ:
            - Теплый, благодарный тон
            - Искренние пожелания
            - Философские размышления о красоте
            - Личное обращение
            ...
            Пиши как финальную главу романа с благодарностью."""
        }
    ]
