        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-gray-900 dark:text-gray-50">{t('mythic.title')}</span>
            </Link>
          ...
          {/* Navigation Links */}
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-gray-50 mb-4">{t('footer.nav.title')}</h3>
            <ul className="space-y-3">
              <li><Link to="/" className="text-gray-500 dark:text-gray-400 hover:text-purple-600 transition-colors">{t('footer.nav.home')}</Link></li>
              <li><Link to="/generate" className="text-gray-500 dark:text-gray-400 hover:text-purple-600 transition-colors">{t('footer.nav.create')}</Link></li>
              <li><Link to="/library" className="text-gray-500 dark:text-gray-400 hover:text-purple-600 transition-colors">{t('footer.nav.library')}</Link></li>
            </ul>
          </div>

          {/* Help Links */}
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-gray-50 mb-4">{t('footer.help.title')}</h3>
            <ul className="space-y-3">
              <li><Link to="/help" className="text-gray-500 dark:text-gray-400 hover:text-purple-600 transition-colors">{t('footer.help.faq')}</Link></li>
              <li><a href="mailto:support@mythicai.com" className="text-gray-500 dark:text-gray-400 hover:text-purple-600 transition-colors">{t('footer.help.support')}</a></li>
            </ul>
          </div>
          
          {/* Social Links */}
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-gray-50 mb-4">{t('footer.social.title')}</h3>
