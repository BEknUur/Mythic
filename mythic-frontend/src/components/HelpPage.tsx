...
const faqItems = [
  ...
  },
  {
    ...
    answer: "Обычно процесс занимает от 5 до 15 минут в зависимости от количества фотографий в вашем профиле и текущей нагрузки на сервер. Вы получите уведомление, когда ваша книга будет готова."
  },
  {
